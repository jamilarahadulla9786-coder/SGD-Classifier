...
2. Load the dataset Placement_Data.csv using pandas.
3. Load the dataset Placement_Data.csv using pandas.
4. Convert categorical variables into numerical form using One-Hot Encoding.
...
## Output:
<img width="812" height="383" alt="Screenshot 2026-03-09 110738" src="https://github.com/user-attachments/assets/5fd9f5a2-b012-487b-8567-1a761857bab2" />
